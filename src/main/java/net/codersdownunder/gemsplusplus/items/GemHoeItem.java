...
public class GemHoeItem extends HoeItem {
	...
	public GemHoeItem(IItemTier tier, int p_i231595_2_, float p_i48488_2_, Properties builder) {
		super(tier, p_i231595_2_, p_i48488_2_, builder);
	...
	public boolean onLeftClickEntity(ItemStack stack, PlayerEntity player, Entity entity) {
		...
		if (stack.getItem() == ItemInit.HOEPHOENIXITE.get()) {
				entity.setFire(60);
		}
	 ...
	 public ActionResultType onItemUse(ItemUseContext context) {
		  ...
		  if (context.getItem().getItem() == ItemInit.HOEPHOENIXITE.get()) {
