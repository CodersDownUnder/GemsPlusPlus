...
public class GemPickaxeItem extends PickaxeItem {

	
	
	public GemPickaxeItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
	...
	public boolean onLeftClickEntity(ItemStack stack, PlayerEntity player, Entity entity) {
		...
		if (stack.getItem() == ItemInit.PICKAXEPHOENIXITE.get()) {
				entity.setFire(60);
		}
	 ...
	 public ActionResultType onItemUse(ItemUseContext context) {
		  ...
		  if (context.getItem().getItem() == ItemInit.PICKAXEPHOENIXITE.get()) {
