...
public class GemSwordItem extends SwordItem {
	...
	public GemSwordItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
	...
	public boolean onLeftClickEntity(ItemStack stack, PlayerEntity player, Entity entity) {
		...
		if (stack.getItem() == ItemInit.SWORDPHOENIXITE.get()) {
				entity.setFire(60);
		}
	 ...
	 public ActionResultType onItemUse(ItemUseContext context) {
		  ...
		  if (context.getItem().getItem() == ItemInit.SWORDPHOENIXITE.get()) {
